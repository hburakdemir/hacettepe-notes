...
const notFound = () => {
  ...
  return (
    <div className="flex flex-col flex-wrap items-center justify-center min-h-screen bg-gray-900 gap-4 space-x-2 text-xl">
      <div className="text-center py-4 px-4 mx-auto w-80 text-primary ">
        ...
        <div className="bg-slate-600 rounded-2xl p-10  text-red-600 mt-4">
          ...
          <button onClick={() => navigate('/')} className="bg-primary rounded-xl p-2 mt-6 text-secondary ">Döneyim Bari</button>
        </div>
