    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center">
          <Shield className="h-10 w-10 mr-3 text-[#2F5755]" />
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <span className="px-3 py-1 bg-[#5A9690] text-white text-sm rounded-full text-center">
                            {post.department}
                          </span>
                        </div>
                    ...
                    <div className="flex space-x-3">
                      <button
                        ...
                        className="flex items-center space-x-2 px-4 py-2 bg-[#2F5755] hover:bg-[#5A9690] text-white rounded-lg transition"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center space-x-2 px-4 py-2 bg-[#C59560] hover:bg-[#FCC61D] text-white rounded-lg transition"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center space-x-2 px-4 py-2 bg-[#660B05] hover:bg-[#8C1007] text-white rounded-lg transition"
                      >
                ...
                {approvedPosts.map((post) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          <span className="px-3 py-1 bg-[#5A9690] text-white text-xs font-medium rounded-full">
                            Onaylandı
                          </span>
                          <span className="text-sm text-gray-500">
                        ...
                        {post.approver_username && (
                          <div className="mb-2">
                            <span className="text-sm bg-[#239BA7] text-white px-3 py-1 rounded-full">
                ...
                {rejectedPosts.map((post) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          <span className="px-3 py-1 bg-[#660B05] text-white text-xs font-medium rounded-full">
                            Reddedildi
                          </span>
                          <span className="text-sm text-gray-500">
                            Paylaşılma: {formatDate(post.created_at)}
                        ...
                        {post.rejecter_username && (
                          <div className="mb-2">
                            <span className="text-sm text-white bg-[#9e2d2d] px-3 py-1 rounded-full">
          ...
          <div>
            {allUsers.length === 0 ? (
              <div className="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <p className="text-gray-500 text-lg">Kullanıcı bulunmuyor.</p>
              </div>
            ) : (
              <>
                {/* normal menü  */}
                    ...
                    >
                      ...
                      <div className="space-y-2 mb-3">
                        <div className="flex items-center text-sm">
                          ...
                          <span className="text-black flex-1 break-all">
                            {userItem.email}
                          </span>
                        </div>
                        <div className="flex items-center text-sm">
